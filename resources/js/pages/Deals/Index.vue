    ...
    <div class="flex flex-col min-h-full bg-app-bg text-app" style="font-family: Inter, sans-serif;">
        ...
        <div class="px-6 py-6">
                ...
                >
                    ...
                    <div class="px-5 py-4 border-b border-app flex items-center justify-between gap-3">
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">${{ stageTotal(stageDeals) }} total</p>
                        </div>
                    ...
                    <div class="p-3 flex flex-col gap-2">
                        ...
                        >
                            <div class="min-w-0 flex-1">
                                ...
                                <p v-if="deal.value" class="text-xs text-slate-500 mt-0.5">
                                    ${{ Number(deal.value).toLocaleString() }}
                                </p>
                                <p v-else class="text-xs text-slate-600 mt-0.5">No value</p>
                            </div>
                            <button
            ...
            <div v-else class="flex flex-col items-center justify-center py-20 text-center">
                ...
                <p class="text-sm text-slate-500 mb-4">Add your first deal to start tracking your pipeline.</p>
                <Link
                    href="/deals/create"
