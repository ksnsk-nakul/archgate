...
<template>
    ...
    <div class="flex flex-col min-h-full bg-app-bg text-app" style="font-family: Inter, sans-serif;">
        ...
        <Form v-bind="store.form()" class="px-4 py-6 md:px-6 max-w-2xl flex flex-col gap-5" v-slot="{ errors, processing }">
            ...
            <div class="flex items-center gap-3">
                ...
                <button type="button" class="text-xs font-semibold text-app-muted border border-app hover:text-app hover:border-app px-4 py-2.5 rounded-lg transition-colors" @click="router.visit('/tasks')">Cancel</button>
            </div>
        </Form>
    </div>
</template>
